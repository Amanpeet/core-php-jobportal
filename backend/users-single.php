      ...
      <table class="table table-bordered table-striped table-sm table-responsive-md">
        <tbody>
          ...
          <tr>
            ...
            <td>
              <?php $edu2 = unserialize($fet2['education2']); // echo $fet2['education2']; ?>
              <span class="text-muted">Course:</span> <?php echo $edu2['edu_course_2']; ?>
              <span class="text-muted pl-5">Institute:</span> <?php echo $edu2['edu_institute_2']; ?>
              <span class="text-muted pl-5">Year:</span> <?php echo $edu2['edu_year_2']; ?>
            </td>
          </tr>
          <tr>
            <td> Education 3 </td>
            <td>
              <?php $edu3 = unserialize($fet2['education3']); // echo $fet2['education3']; ?>
              <span class="text-muted">Course:</span> <?php echo $edu3['edu_course_3']; ?>
              <span class="text-muted pl-5">Institute:</span> <?php echo $edu3['edu_institute_3']; ?>
              <span class="text-muted pl-5">Year:</span> <?php echo $edu3['edu_year_3']; ?>
            </td>
          </tr>
          <tr>
            <td> Education 4 </td>
            <td>
              <?php $edu4 = unserialize($fet2['education4']); // echo $fet2['education4']; ?>
              <span class="text-muted">Course:</span> <?php echo $edu4['edu_course_4']; ?>
              <span class="text-muted pl-5">Institute:</span> <?php echo $edu4['edu_institute_4']; ?>
              <span class="text-muted pl-5">Year:</span> <?php echo $edu4['edu_year_4']; ?>
            </td>
          </tr>
          <tr>
            <td> Experience 1 </td>
            <td>
              <?php $exp1 = unserialize($fet2['experience1']); // echo $fet2['experience1']; ?>
              <span class="text-muted">Title:</span> <?php echo $exp1['exp_title_1']; ?>
              <span class="text-muted pl-5">Company:</span> <?php echo $exp1['exp_company_1']; ?>
              <span class="text-muted pl-5">Years:</span> <?php echo $exp1['exp_years_1']; ?>
            </td>
          </tr>
          <tr>
            <td> Experience 2 </td>
            <td>
              <?php $exp2 = unserialize($fet2['experience2']); // echo $fet2['experience2']; ?>
              <span class="text-muted">Title:</span> <?php echo $exp2['exp_title_2']; ?>
              <span class="text-muted pl-5">Company:</span> <?php echo $exp2['exp_company_2']; ?>
              <span class="text-muted pl-5">Years:</span> <?php echo $exp2['exp_years_2']; ?>
            </td>
          </tr>
          <tr>
            <td> Experience 3 </td>
            <td>
              <?php $exp3 = unserialize($fet2['experience3']); // echo $fet2['experience3']; ?>
              <span class="text-muted">Title:</span> <?php echo $exp3['exp_title_3']; ?>
              <span class="text-muted pl-5">Company:</span> <?php echo $exp3['exp_company_3']; ?>
              <span class="text-muted pl-5">Years:</span> <?php echo $exp3['exp_years_3']; ?>
            </td>
          </tr>
          <tr>
            <td> Experience 4 </td>
            <td>
              <?php $exp4 = unserialize($fet2['experience4']); // echo $fet2['experience4']; ?>
              <span class="text-muted">Title:</span> <?php echo $exp4['exp_title_4']; ?>
              <span class="text-muted pl-5">Company:</span> <?php echo $exp4['exp_company_4']; ?>
              <span class="text-muted pl-5">Years:</span> <?php echo $exp4['exp_years_4']; ?>
            </td>
          </tr>
          <tr>
            <td> Linkedin </td>
